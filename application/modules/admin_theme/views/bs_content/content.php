            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <?php echo form_open('',array('id'=>'insert_test','name'=>'insert_test','role'=>'form'));?>
                        ...
                        echo form_dropdown('type', $province_list, set_select('province',(isset($_POST['province']) ? $_POST['province'] : ''), TRUE),$option);
                        ?>
                        </div>
                        ...
                        echo form_dropdown('district', $options, set_select('district',(isset($_POST['district']) ? $_POST['district'] : ''), TRUE),$option);
                        ?>
                        </div>
                        ...
                        echo form_dropdown('type', $options,"Xã",$option);
                        ?>
