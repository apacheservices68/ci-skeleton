...
$lang['file_required']					= "Trường %s bắc buộc";
$lang['file_size_max']					= "File %s là quá lớn (Tối đa là %s).";
...
$lang['valid_hour']						= "The field %s must be a valid hour.";
...
$lang['valid_date']						= "The field %s must be a valid date.";
$lang['valid_range_date']				= "The field %s must be a valid date range.";
$lang['required']						= "Trường %s là bắc buộc";
