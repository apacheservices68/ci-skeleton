 ...
 *
 */
$config['set_home'] = "<i class='icon-home relative' style='top:-2px;'></i>";
 ...
 * $config['delimiter'] = ' > ';
 */
$config['delimiter'] = "<i class='icon-arrow-right-5 fg-gray font10 relative' style='top:-2px;'></i>";
 ...
 */
$config['exclude'] = array('loai-rao','khu-vuc','thoi-gian','menu','gia-ca','trang','gia-tien','hang-san-xuat','chi-tiet-san-pham','loai-san-pham','tinh-trang-khuyen-mai','sap-xep-gia','tinh-trang-hang','tim-kiem','thanh-vien');
